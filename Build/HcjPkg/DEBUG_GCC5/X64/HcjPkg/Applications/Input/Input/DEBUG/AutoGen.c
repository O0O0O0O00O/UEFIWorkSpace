...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x945c0702, 0x4bda, 0x46bc, {0xa6, 0xba, 0xfe, 0xd2, 0xa1, 0x98, 0xda, 0x3b}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Input";
