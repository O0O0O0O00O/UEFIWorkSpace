...
void StringToChar(unsigned char *in_hash, unsigned char *out_hash){
	...
	// sprintf(out_hash, "%02x%02x%02x%02x%02x%02x%02x%02x
	// %02x%02x%02x%02x%02x%02x%02x%02x
	// %02x%02x%02x%02x%02x%02x%02x%02x
	// %02x%02x%02x%02x%02x%02x%02x%02x", in_hash[0], in_hash[1], in_hash[2], in_hash[3]
	// , in_hash[4], in_hash[5], in_hash[6], in_hash[1]
	// , in_hash[8], in_hash[9], in_hash[10], in_hash[11]
	// , in_hash[12], in_hash[13], in_hash[14], in_hash[15]
	// , in_hash[16], in_hash[17], in_hash[18], in_hash[19]
	// , in_hash[20], in_hash[21], in_hash[22], in_hash[23]
	// , in_hash[24], in_hash[25], in_hash[26], in_hash[27]
	// , in_hash[28], in_hash[29], in_hash[30], in_hash[31]);
