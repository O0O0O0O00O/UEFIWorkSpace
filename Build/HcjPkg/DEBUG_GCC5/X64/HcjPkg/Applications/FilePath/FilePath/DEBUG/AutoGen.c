...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x58399220, 0x1313, 0x45ca, {0xaf, 0x02, 0x09, 0x5c, 0xb5, 0xa5, 0xbc, 0x90}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FilePath";
